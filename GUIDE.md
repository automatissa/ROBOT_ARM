...
- Bouton **CALIBRER TABLE** : pour définir la zone de travail
...
### Vues (panneau droit, quand la détection tourne)
...
La vue Détection affiche un repère image en haut à gauche (flèche rouge X vers la droite, flèche verte Y vers le bas) et les dimensions de l'image.
